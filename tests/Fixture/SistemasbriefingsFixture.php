...
/**
 * SistemasbriefingsFixture
 */
class SistemasbriefingsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'smcplan_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'sistema_id_UNIQUE' => ['type' => 'unique', 'columns' => ['sistema_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'MyISAM',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'sistema_id' => 1,
                'dataregistro' => '2019-04-29 14:21:24',
                'departamento_id' => 1,
                'objetivo' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                'created' => '2019-04-29 14:21:24',
                'modified' => '2019-04-29 14:21:24',
                'smcplan_id' => 1
            ],
        ];
        parent::init();
