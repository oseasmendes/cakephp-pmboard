...
class IntegrationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'referencia' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'servico' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-04-10 16:59:14',
                'modified' => '2019-04-10 16:59:14'
            ],
        ];
        parent::init();
    }
