...
/**
 * ProjetosoutofscopesFixture
 */
class ProjetosoutofscopesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'responsavel' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'statusfunctional_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'statusfunctional_id' => 1,
                'created' => '2021-08-23 13:55:17',
                'modified' => '2021-08-23 13:55:17'
            ],
        ];
        parent::init();
    }
