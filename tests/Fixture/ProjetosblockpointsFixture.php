...
/**
 * ProjetosblockpointsFixture
 */
class ProjetosblockpointsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'resolvidoem' => '2021-08-05',
                'planoacao' => 1,
                'ativo' => 1,
                'risco' => 1,
                'flag' => 1,
                'created' => '2021-08-05 10:18:18',
                'modified' => '2021-08-05 10:18:18'
            ],
        ];
        parent::init();
    }
