...
/**
 * AtaconsultoresFixture
 */
class AtaconsultoresFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'participante_id' => ['type' => 'index', 'columns' => ['consultore_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'ata_id' => 1,
                'consultore_id' => 1,
                'created' => '2020-02-04 18:25:26',
                'modified' => '2020-02-04 18:25:26'
            ],
        ];
        parent::init();
    }
