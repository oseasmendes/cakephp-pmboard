...
/**
 * ProjetosprodutosriscoseventosFixture
 */
class ProjetosprodutosriscoseventosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'projetosprodutosrisco_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-10-03 09:28:47',
                'modified' => '2019-10-03 09:28:47'
            ],
        ];
        parent::init();
    }
