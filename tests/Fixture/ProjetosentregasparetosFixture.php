...
/**
 * ProjetosentregasparetosFixture
 */
class ProjetosentregasparetosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'responsabilidade_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'idx_prodentr_id' => ['type' => 'index', 'columns' => ['projetosprodutosentrega_id', 'created'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-04-23 20:13:54',
                'modified' => '2019-04-23 20:13:54',
                'motivo_id' => 1,
