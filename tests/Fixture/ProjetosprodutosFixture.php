...
/**
 * ProjetosprodutosFixture
 */
class ProjetosprodutosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'produto' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'codenome' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'projeto_id' => 1,
                'created' => '2019-05-09 17:05:48',
                'modified' => '2019-05-09 17:05:48',
                'codenome' => 'Lorem ipsum dolor sit amet',
                'referencia' => 'Lorem ipsum dolor sit amet',
                'statusfuncional_id' => 1,
                'descricao' => 'Lorem ipsum dolor sit amet',
                'prioridade' => 1,
                'dataprevista' => '2019-05-09',
                'datarealizada' => '2019-05-09',
                'frente_id' => 1
            ],
        ];
        parent::init();
