...
/**
 * ProjetosparetosFixture
 */
class ProjetosparetosFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            'idx_projeto_id' => ['type' => 'index', 'columns' => ['projeto_id'], 'length' => []],
            'idx_created' => ['type' => 'index', 'columns' => ['created'], 'length' => []],
            'idx_prjid_create' => ['type' => 'index', 'columns' => ['projeto_id', 'created'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-04-23 20:13:44',
                'modified' => '2019-04-23 20:13:44'
            ],
        ];
        parent::init();
    }
