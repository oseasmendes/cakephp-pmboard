...
/**
 * ProjetoscutoversflwsFixture
 */
class ProjetoscutoversflwsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'projetoscutover_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'projetoscutover_id' => 1,
                'dataemissao' => '2021-09-08',
                ...
                'ativo' => 1,
                'created' => '2021-09-08 13:21:40',
                'modified' => '2021-09-08 13:21:40'
            ],
        ];
        parent::init();
    }
