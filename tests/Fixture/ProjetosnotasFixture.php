...
/**
 * ProjetosnotasFixture
 */
class ProjetosnotasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            'idx_projnotas_notaid' => ['type' => 'index', 'columns' => ['notatipo_id'], 'length' => []],
            'idx_idx_projnotas_projid' => ['type' => 'index', 'columns' => ['projeto_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-04-18 19:33:51',
                'modified' => '2019-04-18 19:33:51',
                'projeto_id' => 1,
