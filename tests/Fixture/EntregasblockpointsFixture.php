...
/**
 * EntregasblockpointsFixture
 */
class EntregasblockpointsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'resolvidoem' => '2022-05-27',
                'planoacao' => 1,
                'ativo' => 1,
                'risco' => 1,
                'flag' => 1,
                'created' => '2022-05-27 10:18:37',
                'modified' => '2022-05-27 10:18:37'
            ],
        ];
        parent::init();
    }
