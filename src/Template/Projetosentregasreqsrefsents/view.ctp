...
<div class="projetosentregasreqsrefsents view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            <th scope="row"><?= __('Projetosentregasreqsref') ?></th>
            <td><?= $projetosentregasreqsrefsent->has('projetosentregasreqsref') ? $this->Html->link($projetosentregasreqsrefsent->projetosentregasreqsref->descricao, ['controller' => 'Projetosentregasreqsrefs', 'action' => 'view', $projetosentregasreqsrefsent->projetosentregasreqsref->id]) : '' ?></td>
        </tr>
        <tr>
