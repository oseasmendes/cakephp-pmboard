...
class ProjetosentregasreqsrefsentsController extends AppController
{
    ...
    public function add()
    {
        ...
        $projetosentregasreqsrefs = $this->Projetosentregasreqsrefsents->Projetosentregasreqsrefs->find('list', ['limit' => 200]);
        $this->set(compact('projetosentregasreqsrefsent', 'projetosentregasreqsrefs'));
    }
    ...
    public function addid($id = null)
    {
        ...
        $projetosentregasreqsrefs = $this->Projetosentregasreqsrefsents->Projetosentregasreqsrefs->find('list', array('conditions'=>array('Projetosentregasreqsrefs.id'=>$id),'order' => array('Projetosentregasreqsrefs.id' => 'asc')));
        $this->set(compact('projetosentregasreqsrefsent', 'projetosentregasreqsrefs'));
    }
